...
import controle.ControleCreche;
 ...
 */
public class TelaCreche extends javax.swing.JFrame {
    // Declaracoes
    ...
    private final ControleCreche controleCreche;
    ...
    public TelaCreche() {
        ...
        controleCreche = new ControleCreche(this);
        // Atualizar combo box
        controleCreche.atualizarHospitaleiros();
        this.jCmbBoxPet.removeAllItems(); // Limpar combo box
        controleCreche.atualizarPets();
    }
    ...
    private void componentes() {
        ...
        jCmbBoxPet.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCmbBoxPetActionPerformed(evt);
            }
        });
        ...
        jLbDataSaida.setBounds(550, 280, 120, 25);
        ...
        jButtonReservar.setText("Hospedar");
    ...
    private void ButtonHospedarActionPerformed(java.awt.event.ActionEvent evt) {                                              
        controleCreche.cadastrar();
    } 
    
    private void jCmbBoxPetActionPerformed(java.awt.event.ActionEvent evt) {                                            
        //this.jCmbBoxPet.removeAllItems(); // Limpar combo box
        //controleCreche.atualizarPets();
    }    
