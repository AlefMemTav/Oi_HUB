...
public class TelaHospedagem extends javax.swing.JFrame {
    ...
    private final ControleHospedagem controleHospedagem;
    ...
    public TelaHospedagem() {
        ...
        controleHospedagem = new ControleHospedagem(this);
        // Atualizar combo box
        controleHospedagem.atualizarHospitaleiros();
        this.jCmbBoxPet.removeAllItems(); // Limpar combo box
        controleHospedagem.atualizarPets();
    }
    ...
    private void jMenuVoltarMouseClicked(java.awt.event.MouseEvent evt) {
        controleHospedagem.irParaMenu(); // Ir para a tela de menu
        controleHospedagem.fecharHospedagem(); // Fechar tela de hospedagem
    }

    // Menu reservas
    private void jMenuReservasMouseClicked(java.awt.event.MouseEvent evt) {
        // Ir para tela de reservas de hospedagem
        new TelaHospedagemReservas().setVisible(true);
    }

    /* Item state changed */
    // Combo box hospitaleiro
    private void jCmBoxHospitaleiroItemStateChanged(java.awt.event.ItemEvent evt) {
        controleHospedagem.atualizarValor(); // Atualizar campo de valor
        controleHospedagem.atualizarCidade(); // Atualizar campo de cidade
    }
