...
public class BancoDeDados {
    ...
    public static void dadosIniciais(){
        ...
        Pet pet3 = new Pet(3, 3, "Garfild", "Nao", "Gato", "Macho", "Persa", "Grande");
        
        Cliente cliente1 = new Cliente(1, "Pedro Lucas", "pedro@email.com", pet1);
        Cliente cliente2 = new Cliente(2, "Fabiana", "fabiana@email.com", "Mansao 3 Lago Norte Brasilia DF", pet2);
        Cliente cliente3 = new Cliente(3, "Arthur", "arthur@email.com", pet3);
        
        Hospitaleiro hospitaleiro1 = new Hospitaleiro(1, "Pedro Lucas", "pedro@email.com", "11/12/1908", "Rua 1 Casa 2 Gama DF", "Masculino", "Casa", 1, 20);
        Hospitaleiro hospitaleiro2 = new Hospitaleiro(2, "Caio Oliveira", "caio@email.com", "25/03/1999", "Rua 2 Casa 1 Gama DF", "Masculino", "Casa", 1, 40);
        
        Hospedagem hospedagem1 = new Hospedagem(1, "08/03/2022", "09/03/2022", "11:00", "09:00", 1, hospitaleiro1, cliente1, pet1);
        Hospedagem hospedagem2 = new Hospedagem(2, "09/03/2022", "10/03/2022", "12:00", "06:00", 1, hospitaleiro1, cliente2, pet2);
